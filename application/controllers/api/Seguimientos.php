...
class Seguimientos extends REST_Controller
{
	...
	public function registrar_seguimiento_post()
	{
		...
		else
		{
			...
			$this->Auditoria_model->agregar($this->session->userdata('id'),'T_Seguimiento' ,'INSERT',$CodSeg,$this->input->ip_address(),'Proceso de Registro de Seguimientos.');
			$tabla="T_Cliente";
			$where="CodCli";
