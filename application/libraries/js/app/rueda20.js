app.controller('Controlador_Rueda20', ['$http', '$scope', '$filter', '$route', '$interval', '$controller', '$cookies', '$compile', Controlador])
...
function Controlador($http, $scope, $filter, $route, $interval, $controller, $cookies, $compile) {
    ...
    $scope.submitFormRueda = function(event)
    {
        ...
        var url=base_urlHome()+"api/Reportes/Generar_Rueda20/";
