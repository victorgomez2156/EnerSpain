...
function Controlador($http,$scope,$filter,$route,$interval,$controller,$cookies)
{
	...
	{		
		...
		var url=base_urlHome()+"api/Configuraciones_Generales/crear_comercial/";
		$http.post(url,scope.fdatos).then(function(result)
		{
			...
			if(scope.nID>0)
			{
				...
				bootbox.alert({
				message: "El Comercial a sido registrada correctamente.",
				size: 'middle'});
				scope.buscarXID();				
			}
			else
	...
	scope.cargar_lista_comercial=function()
	{
		...
		var url = base_urlHome()+"api/Configuraciones_Generales/list_comercial/";
	...
	scope.buscarXID=function()
	{
		...
		var url = base_urlHome()+"api/Configuraciones_Generales/buscar_xID_Comercial/CodCom/"+scope.nID;
		$http.get(url).then(function(result)
		{
			if(result.data!=false)
			{
	...
	scope.borrar_row=function(index,id)
	{
		...
		callback: function (result) 
		{
			...
			{					
				...
				var url = base_urlHome()+"api/Configuraciones_Generales/borrar_row_comercial/CodCom/"+id;
	...
	scope.borrar=function()
	{
		...
		callback: function (result) 
		{
			...
			{					
				$("#borrando").removeClass( "loader loader-default" ).addClass( "loader loader-default  is-active");
				var url = base_urlHome()+"api/Configuraciones_Generales/borrar_row_comercial/CodCom/"+scope.fdatos.CodCom;
				$http.delete(url).then(function(result)
				{
					if(result.data!=false)
					{
