...
function Controlador($http,$scope,$filter,$route,$interval,$controller,$cookies)
{
	...
	scope.tMotivos_Bloqueos=undefined;
	scope.tMotivos_BloqueosBack=undefined;	
	scope.index=0;
	...
	{		
		...
		var url=base_urlHome()+"api/Configuraciones_Generales/crear_tMotivos_Bloqueos/";
		$http.post(url,scope.fdatos).then(function(result)
		{
			scope.nID=result.data.CodMotBloCli;
			if(scope.nID>0)
			{
	...
	scope.cargar_lista_tMotivos_Bloqueos=function()
	{
		$("#cargando").removeClass( "loader loader-default" ).addClass( "loader loader-default  is-active");
		var url = base_urlHome()+"api/Configuraciones_Generales/list_tMotivos_Bloqueos/";
		$http.get(url).then(function(result)
		{
			if(result.data!=false)
			{
				...
				scope.tMotivos_Bloqueos=result.data;
				scope.tMotivos_BloqueosBack=result.data;					
				$scope.totalItems = scope.tMotivos_Bloqueos.length; 
				$scope.numPerPage = 50;  
				...
				{  
					...
					index = scope.tMotivos_Bloqueos.indexOf(value);  
					return (begin <= index && index < end);  
				};				
				//console.log(scope.tMotivos_Bloqueos);
			}
			else
			{
				$("#cargando").removeClass( "loader loader-default is-active" ).addClass( "loader loader-default" );
	...
	scope.buscarXID=function()
	{
		...
		var url = base_urlHome()+"api/Configuraciones_Generales/buscar_xID_tMotivo_Bloqueo/CodMotBloCli/"+scope.nID;
		$http.get(url).then(function(result)
		{
			if(result.data!=false)
			{
	...
	scope.borrar_row=function(index,id)
	{
		...
		callback: function (result) 
		{
			...
			{					
				...
				var url = base_urlHome()+"api/Configuraciones_Generales/borrar_row_tMotivos_Bloqueos/CodMotBloCli/"+id;
				$http.delete(url).then(function(result)
				{
					if(result.data!=false)
					{
						...
						size: 'middle'});
						scope.tMotivos_Bloqueos.splice(index,1);
					}
					else
					{
						$("#borrando").removeClass( "loader loader-default is-active" ).addClass( "loader loader-default" );
	...
	scope.borrar=function()
	{
		...
		callback: function (result) 
		{
			...
			{					
				$("#borrando").removeClass( "loader loader-default" ).addClass( "loader loader-default  is-active");
				var url = base_urlHome()+"api/Configuraciones_Generales/borrar_row_tMotivos_Bloqueos/CodMotBloCli/"+scope.fdatos.CodMotBloCli;
				$http.delete(url).then(function(result)
				{
					if(result.data!=false)
					{
	...
	/*else
	{
		scope.cargar_lista_tMotivos_Bloqueos();
	}*/	
}			