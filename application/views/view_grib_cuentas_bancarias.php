 ...
 <!--main content start-->
    <section id="main-content">
      ...
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-bank"></i> Cuentas Bancarias</h3>
            <ol class="breadcrumb">
            ...
            <div class="t-0029"><!--t-0029 start--> 
              <div class="t-0031" style="margin-top: -8px; "><!--t-0031 start-->
                ...
                <ul class="dropdown-menu">
                  <li><input type="checkbox" ng-model="vm.ClieCueBan"/> <i class="fa fa-plus-square"></i> <b style="color:black;">CLIENTES</b></li>
      ...
      <br><br><br><br>
       <div class="table-responsive">
          <table class="table table-striped table-advance table-hover table-responsive">
                <tbody>
                  <tr>
                  <th ng-show="vm.ClieCueBan==true"><i class="fa fa-users"></i> CLIENTES</th>
                  ...
                  <tr ng-repeat="dato in vm.tCuentaBan | filter:paginate3 | filter:vm.tgribBancos.filtrar" ng-class-odd="odd">
                    <td ng-show="vm.ClieCueBan==true">{{dato.NumCifCli}} - {{dato.RazSocCli}}</td>
   ...
   <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="modal_filtros_bancos" class="modal fade">
    ...
    <div style="margin-left:15px; ">
     <button class="btn btn-info" type="submit" ng-disabled="frmfiltrobancos.$invalid"><i class="fa fa-check-circle"></i> APLICAR</button>
      <a class="btn btn-danger" ng-click="vm.regresar_filtro_bancos()"><i class="fa fa-trash"></i> LIMPIAR FILTRO</a>
      </div>
</form>
   </div>
    </div>
...
<div id="cuentas_bancarias" class="loader loader-default"  data-text="Cargando lista de Cuentas Bancarias, Por Favor Espere..."></div>
