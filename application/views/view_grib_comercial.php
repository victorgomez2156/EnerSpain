                ...
                <tbody>
                  ...
                  <tr ng-repeat="dato in vm.TComercial | filter:paginate | filter:vm.filtrar" ng-class-odd="odd">
                    ...
                    <td ng-show="vm.AccCom==true">
                      <div class="btn-group">
                        <select class="form-control" id="opciones_comercial" name="opciones_comercial" ng-model="vm.opciones_comercial[$index]" ng-change="vm.validar_opcion($index,vm.opciones_comercial[$index],dato)">
                      ...
                      <div class="modal-body">
                        <form class="form-horizontal" role="form" id="DNI_NIE_consulta_form" name="DNI_NIE_consulta_form" ng-submit="Consultar_DNI_NIE($event)"> 
                          <div class="form-group">
                            ...
                            <div class="col-lg-10">
                              <input type="text" class="form-control" ng-model="vm.fdatos.NumDNI_NIECli" onkeyup="this.value=this.value.toUpperCase();" placeholder="* Ingrese Número de DNI/NIE" maxlength="9" required/>   
                            </div>
                          </div>
