 ...
 <form id="register_form2" name="register_form2" ng-submit="submitFormPuntoSuministro($event)"> 
     <div class='row'>              
      ...
      <div class="col-12 col-sm-5">
       ...
       <input type="text" class="form-control" ng-click='vm.searchboxClicked($event)' ng-model="vm.fpuntosuministro.CPLocSoc" placeholder="Zona Postal" ng-disabled="vm.validate_info_PunSum!=undefined|| vm.fpuntosuministro.TipRegDir==undefined" ng-keyup='vm.LocalidadCodigoPostal(1)'/>
        <ul id='searchResult'>
