                      ...
                      <div class="modal-body">
                        <form class="form-horizontal" role="form" id="dni_contacto" name="dni_contacto" ng-submit="Consultar_CIF_Contacto($event)"> 
                          <div class="form-group">
                            ...
                            <div class="col-lg-10">
                              <input type="text" class="form-control" ng-model="vm.tContacto_data_modal.NIFConCli" id="NIFConCli1" name="NIFConCli1" placeholder="* introduzca Número de DNI/NIE"   maxlength="9" required onkeyup="this.value=this.value.toUpperCase();" />   
                            </div>
                          </div>
                          <p id="iLetter"></p>
