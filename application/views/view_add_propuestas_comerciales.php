        ...
        <div >
          ...
          <div class="col-12 col-sm-2">
            <div class="form">                          
             ...
             <input type="checkbox"  class="form-control" style="margin-top: -1px;" ng-model="vm.fdatos.RenConEle" ng-disabled="vm.fdatos.CodCupSEle==undefined || vm.fdatos.tipo=='ver'|| vm.fdatos.EstProCom=='C'|| vm.fdatos.tipo=='renovar'"/>     
             </div>
             </div>
          </div>
        ...
        <div >
          ...
          <div class="col-12 col-sm-1">
            <div class="form">                          
             ...
             <input type="checkbox"  class="form-control" style="margin-top: -1px;" ng-model="vm.fdatos.RenConGas" ng-disabled="vm.fdatos.CodCupGas==undefined || vm.fdatos.tipo=='ver'|| vm.fdatos.EstProCom=='C' || vm.fdatos.tipo=='renovar'"/>     
             </div>
             </div>
          </div>
        <div class="form" >                          
