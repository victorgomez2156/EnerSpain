 ...
 <div ng-controller="Controlador_Empleados as vm">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-users"></i> Registro de Usuarios</h3>
            <ol class="breadcrumb">
             <li><i class="fa fa-home"></i><a href="#/Dashboard">Dashboard</a></li>             
              <li><i class="fa fa-users"></i>Registro de Usuarios</li>
            </ol>
          </div>
        </div>
        <!-- Form validations -->
...
<div id="cargando" class="loader loader-default"  data-text="Cargando datos de Usuarios, Por Favor Espere..."></div>
<div id="crear_usuario" class="loader loader-default"  data-text="Creando o Actualizando Usuario, Por Favor Espere..."></div>
