 ...
 <!--main content start-->
    <section id="main-content">
      ...
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-bolt"></i> Tarifa Gas</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="#/Dashboard">Dashboard</a></li>              
              <li><i class="fa fa-bolt"></i>Tarifa Gas</li>
            </ol>
          </div>
        </div>
        <!-- page start-->
      ...
      <div class="t-0031" style="margin-top: -8px; ">
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu">                        
                        <li><input type="checkbox" ng-model="vm.NomTarGas"/> <i class="fa fa-plus-square"></i> <b style="color:black;">Nomenclatura</b></li>
                        <li><input type="checkbox" ng-model="vm.MinConAnu"/> <i class="fa fa-plus-square"></i> <b style="color:black;">Minimo Consumo Anual</b></li>
                        <li><input type="checkbox" ng-model="vm.MaxConAnu"/> <i class="fa fa-plus-square"></i> <b style="color:black;">Maximo Consumo Anual</b></li>
                    ...
                    <div class="btn-group">
                       <a data-toggle="modal" title='Filtros' data-target="#modal_filtros_Tarifa_Gas" class="btn btn-default"><div><i class="fa fa-filter"></i><span class="caret"></span></div></a>
                    </div-->
    </div>
  </div>
</div>     
              <div style="float:right;margin-left: 0px;padding: 0px;margin-top: 10px;margin-bottom: 2px; " class="removeForMobile">                   
                <div class="t-0029">
                  <form class="form-inline" role="form">
                    ...
                    <a style="margin-right: 10px;" class="btn btn-info" title="Agregar Tarifa Gas" href="#/Add_Tarifa_Gas"><i class="fa fa-plus-square"></i></a>
                  </form>                    
                  </div>
              </div>
</div>  <!--t-0002 end-->    
      ...
      <div class="table-responsive">
          <table class="table table-striped table-advance table-hover table-responsive" ng-init="vm.cargar_lista_Tarifa_Gas()">
                <tbody>
                  ...
                  <tr ng-show="vm.Tarifa_Gas==undefined"> 
                     <td colspan="5" align="center"><div class="td-usuario-table"><i class="fa fa-close"></i> Actualmente no hay datos disponibles.</div></td>           
                    </tr>
                  <tr ng-repeat="dato in vm.Tarifa_Gas | filter:paginate | filter:vm.filtrar_tarifa_electrinca" ng-class-odd="odd">
                    
                    <td ng-show="vm.NomTarGas==true">{{dato.NomTarGas}}</td>
                    <td ng-show="vm.MinConAnu==true">{{dato.MinConAnu}}</td>
                    <td ng-show="vm.MaxConAnu==true">{{dato.MaxConAnu}}</td>                    
                    <td ng-show="vm.AccTarGas==true">                     
                      <a href="#/Edit_Tarifa_Gas/{{dato.CodTarGas}}" title='Editar Tarifa Gas' class="btn btn-info btn-icon mg-r-5"><div><i class="fa fa-edit" style="color:white;"></i></div></a>
                      <a ng-click="vm.borrar_row($index,dato.CodTarGas)" title='Eliminar Tarifa Gas' class="btn btn-danger btn-icon mg-r-5"><div><i class="fa fa-trash" style="color:white;"></i></div></a>
...
<div id="cargando" class="loader loader-default"  data-text="Cargando lista de Tarifa Gas, Por Favor Espere..."></div>
<div id="borrando" class="loader loader-default"  data-text="Borrando Tarifa Gas, Por Favor Espere..."></div> 
</html>
