...
<body>
  <div ng-controller="Controlador_Ingresos_Reales as vm">
    <!--main content start-->
    <section id="main-content">
      ...
      <div class="row">
            <div class="col-lg-12">
              <h3 class="page-header">Reporte de Ingresos Reales</h3>           
            </div>
      </div>
      ...
      <div class="row">
        ...
        <!--panel start-->
        <section class="panel">
      <form id="form_ingresosreales" name="form_ingresosreales" ng-submit="submitFormIngresosReales($event)">
       ...
       <label class="font-weight-bold nexa-dark" style="color:black;">Año <b style="color:red;">(*)</b></label>
        ...
        <div class="form-group" >
          <div class="col-12 col-sm-12">
            ...
            <a ng-show="vm.excel_ingressos_reales==true" title='Descargar Reporte Ingresos Reales {{vm.fdatos.ano}}' href="documentos/reportes/{{vm.nombre_reporte}}" class="btn btn-success" download><div><i class="fa fa-cloud-download" style="color:white;"></i></div></a>
          </div>
      </div>
</form>
<br>
