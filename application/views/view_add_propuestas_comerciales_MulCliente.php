...
<body>
 <div ng-controller="Controlador_Add_PropuestasMulCliente as vm">
    <!--main content start-->
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header" ng-show="vm.fdatos.tipo=='nueva'">Registro de Propuesta Comercial MultiCliente - MultiPunto</h3>
            <h3 class="page-header" ng-show="vm.fdatos.tipo=='ver'">Consultando Propuesta Comercial MultiCliente - MultiPunto</h3>
            <h3 class="page-header" ng-show="vm.fdatos.tipo=='renovar'">Renovación de Propuesta Comercial MultiCliente - MultiPunto</h3>
            <h3 class="page-header" ng-show="vm.fdatos.tipo=='editar'">Modificando Propuesta Comercial MultiCliente - MultiPunto</h3>
          </div>
        </div>
        <!-- Form validations -->
        <div class="row">
    ...
    <div class="foreign-supplier-title clearfix">
      <h4 class="breadcrumb">     
        <span class="foreign-supplier-text" style="color:black;"> Datos del Representante Legal</span><div align="right" style="margin-top: -16px;"></div>
      </h4>
    </div>
    ...
    <div class="foreign-supplier-title clearfix">
      <h4 class="breadcrumb">     
        <span class="foreign-supplier-text" style="color:black;"> Listado de Clientes & CUPs</span><div align="right" style="margin-top: -16px;"></div>
      </h4>
    </div>
      ...
      <form class="form-validate" id="frmCUPsElectrico" name="frmCUPsElectrico" ng-submit="AgregarCUPsElectricoGas($event,1)">
        ...
        <div class="col-12 col-sm-12" ng-click="vm.containerClicked()">
          ...
          {{ result.CodCli }}, {{ result.NumCifCli }} - {{ result.RazSocCli }} 
             ...
             <input type="hidden" class="form-control" ng-model="vm.CodCliCUPs"/> 
        </div> 
        <div class="col-12 col-sm-6">
            <div class="form">                          
             <div class="form-group">
